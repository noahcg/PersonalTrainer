...
export default async function TrainerMessagesPage() {
  ...
  return (
    <AppShell role="trainer" title="Communications" eyebrow="Client messages" subtitle="Review client conversations and reply from one focused workspace." mobileFocus>
